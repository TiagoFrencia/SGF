...
public final class WsfeSoapEnvelopeBuilder {
    ...
    static int invoiceTypeCode(com.sgf.integrations.afip.domain.AfipInvoiceType invoiceType) {
    ...
    static int documentTypeCode(com.sgf.integrations.afip.domain.AfipDocumentType documentType) {
